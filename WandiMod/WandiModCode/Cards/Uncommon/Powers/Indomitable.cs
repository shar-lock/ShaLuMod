...
/// 战斗结束时回复生命上限 10% 的生命值。升级：12%。
/// —— 续航件：每场战斗结束小额回血，长线作战。
/// 百分比随升级态传入 Power 的 Amount（10→12），由 IndomitablePower.AfterCombatEnd 读取。
/// </summary>
public class Indomitable : WandiModCard
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        // Amount = 回血百分比（10/12），IndomitablePower 据此在 AfterCombatEnd 回 MaxHp*Amount/100

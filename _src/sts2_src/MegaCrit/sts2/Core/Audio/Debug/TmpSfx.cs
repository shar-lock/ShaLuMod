...
// Type: MegaCrit.Sts2.Core.Audio.Debug.TmpSfx
...
public static class TmpSfx
{
  ...
  public static readonly IReadOnlyList<string> assetPaths = (IReadOnlyList<string>) new List<string>()
  {
    "doom_apply.mp3",
    "blunt_attack.mp3",
    "character_unlock.mp3",
    "character_unlock_charge.mp3",
    "card_deal.mp3",
    "card_exhaust.mp3",
    "card_select.mp3",
    "card_smith.mp3",
    ...
    "map_ping.mp3",
    "map_open.mp3",
    "SOTE_Logo_Echoing_ShortTail.mp3",
    "sts_sfx_shovel_v1.mp3",
    "relic_get.mp3",
    "SOTE_SFX_SleepBlanket_v1.mp3",
    "sleep.tres",
    "slash_attack.mp3",
    "enemy_turn.mp3",
    "player_turn.mp3",
    "victory.mp3"
  }.Concat<string>(TmpSfx.BattleStart).Concat<string>(TmpSfx.PotionSlosh).Select<string, string>(new Func<string, string>(TmpSfx.GetPath)).ToList<string>();
  ...
  public static IEnumerable<string> BattleStart
  {
    get
    {
  ...
  public static IEnumerable<string> PotionSlosh
  {
    get
    {
  ...
  public static string GetPath(string sfx) => "res://debug_audio/" + sfx;
}

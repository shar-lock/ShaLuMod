...
// Type: MegaCrit.Sts2.Core.Combat.History.Entries.CardAfflictedEntry
...
public class CardAfflictedEntry : CombatHistoryEntry
{
  ...
  {
    get => $"{this.Actor.Player.Character.Id.Entry} afflicted {this.Card.Id.Entry}";
  }

  public CardAfflictedEntry(
    CardModel card,

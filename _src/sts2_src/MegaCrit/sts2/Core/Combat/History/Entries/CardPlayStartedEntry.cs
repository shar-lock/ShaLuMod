...
// Type: MegaCrit.Sts2.Core.Combat.History.Entries.CardPlayStartedEntry
...
public class CardPlayStartedEntry : CombatHistoryEntry
{
  ...
  public override string Description
  {
    get
    {
      StringBuilder stringBuilder1 = new StringBuilder($"{this.Actor.Player.Character.Id.Entry} started playing {this.CardPlay.Card.Id.Entry}");

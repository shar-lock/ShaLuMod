...
// Type: MegaCrit.Sts2.Core.Models.Badges.MysteryMachine
...
public class MysteryMachine(SerializableRun run, bool won, ulong playerId) : Badge(run, won, playerId, "MYSTERY_MACHINE", false, false)
{
  ...
  public override bool IsObtained()
  {
    ...
    foreach (List<MapPointHistoryEntry> pointHistoryEntryList in this._run.MapPointHistory)
    {
      ...
      {
        if (pointHistoryEntry.MapPointType == MapPointType.Unknown)
          ++num;
      }
    }
    return num >= 15;

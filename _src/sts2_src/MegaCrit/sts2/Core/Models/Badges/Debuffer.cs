...
// Type: MegaCrit.Sts2.Core.Models.Badges.Debuffer
...
public class Debuffer(SerializableRun run, bool won, ulong playerId) : Badge(run, won, playerId, "DEBUFFER", false, true)
{

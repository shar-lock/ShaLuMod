...
// Type: MegaCrit.Sts2.Core.Models.Badges.Restless
...
public class Restless(SerializableRun run, bool won, ulong playerId) : Badge(run, won, playerId, "RESTLESS", true, false)
{

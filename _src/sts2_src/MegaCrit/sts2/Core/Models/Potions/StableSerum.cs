...
// Type: MegaCrit.Sts2.Core.Models.Potions.StableSerum
...
public sealed class StableSerum : PotionModel
{
  ...
  protected override async Task OnUse(PlayerChoiceContext choiceContext, Creature? target)
  {
    ...
    RetainHandPower retainHandPower = await PowerCmd.Apply<RetainHandPower>(choiceContext, target, this.DynamicVars.Repeat.BaseValue, this.Owner.Creature, (CardModel) null);
  }
}

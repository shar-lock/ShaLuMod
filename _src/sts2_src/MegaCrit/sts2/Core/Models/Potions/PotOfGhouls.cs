...
// Type: MegaCrit.Sts2.Core.Models.Potions.PotOfGhouls
...
public sealed class PotOfGhouls : PotionModel
{
  ...
  protected override async Task OnUse(PlayerChoiceContext choiceContext, Creature? target)
  {
    ...
    IEnumerable<Soul> inHand = await Soul.CreateInHand(target.Player, this.DynamicVars.Cards.IntValue, target.CombatState, this.Owner);
  }
}

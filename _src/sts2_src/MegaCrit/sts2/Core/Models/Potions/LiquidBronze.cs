...
// Type: MegaCrit.Sts2.Core.Models.Potions.LiquidBronze
...
public sealed class LiquidBronze : PotionModel
{
  ...
  protected override async Task OnUse(PlayerChoiceContext choiceContext, Creature? target)
  {
    ...
    ThornsPower thornsPower = await PowerCmd.Apply<ThornsPower>(choiceContext, target, this.DynamicVars["ThornsPower"].BaseValue, this.Owner.Creature, (CardModel) null);
  }
}

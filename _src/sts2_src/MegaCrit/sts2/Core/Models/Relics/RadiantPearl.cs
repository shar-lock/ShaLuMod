...
// Type: MegaCrit.Sts2.Core.Models.Relics.RadiantPearl
...
public sealed class RadiantPearl : RelicModel
{
  ...
  protected override IEnumerable<IHoverTip> ExtraHoverTips
  {
    get
    {
      ...
      items.AddRange(HoverTipFactory.FromCardWithCardHoverTips<Luminesce>());
    ...
    ICombatState combatState)
  {
    ...
    for (int index = 0; index < this.DynamicVars.Cards.IntValue; ++index)
      cards.Add((CardModel) this.Owner.Creature.CombatState.CreateCard<Luminesce>(this.Owner));

...
// Type: MegaCrit.Sts2.Core.Models.Relics.PreservedFog
...
public sealed class PreservedFog : RelicModel
{
  ...
  {
    get => HoverTipFactory.FromCardWithCardHoverTips<Folly>();
  }
  ...
  public override async Task AfterObtained()
  {
    ...
    CardModel deck = await CardPileCmd.AddCurseToDeck<Folly>(this.Owner);
  }
}

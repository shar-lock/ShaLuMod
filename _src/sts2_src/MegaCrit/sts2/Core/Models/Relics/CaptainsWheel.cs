...
// Type: MegaCrit.Sts2.Core.Models.Relics.CaptainsWheel
...
public sealed class CaptainsWheel : RelicModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new BlockVar(18M, ValueProp.Unpowered));
    }
  }

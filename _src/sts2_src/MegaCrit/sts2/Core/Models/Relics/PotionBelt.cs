...
// Type: MegaCrit.Sts2.Core.Models.Relics.PotionBelt
...
public sealed class PotionBelt : RelicModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>(new DynamicVar("PotionSlots", 2M));
    }
  }

...
// Type: MegaCrit.Sts2.Core.Models.Relics.FakeBloodVial
...
public sealed class FakeBloodVial : RelicModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new HealVar(1M));
    }
  }

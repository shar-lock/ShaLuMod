...
// Type: MegaCrit.Sts2.Core.Models.Relics.Astrolabe
...
public sealed class Astrolabe : RelicModel
{
  ...
  public override async Task AfterObtained()
  {
    ...
    {
      CardModel cardForTransform = CardFactory.CreateRandomCardForTransform(original, false, this.Owner.RunState.Rng.Niche);
      CardCmd.Upgrade(cardForTransform);
      CardPileAddResult? nullable = await CardCmd.Transform(original, cardForTransform);
    }
  }
}

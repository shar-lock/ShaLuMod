...
// Type: MegaCrit.Sts2.Core.Models.Relics.BeautifulBracelet
...
public sealed class BeautifulBracelet : RelicModel
{
  ...
  {
    get => HoverTipFactory.FromEnchantment<Swift>(this.DynamicVars["Swift"].IntValue);
  }

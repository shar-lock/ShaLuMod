...
// Type: MegaCrit.Sts2.Core.Models.Relics.HornCleat
...
public sealed class HornCleat : RelicModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new BlockVar(14M, ValueProp.Unpowered));
    }
  }
  ...
  {
    if (creature != this.Owner.Creature || this.Owner.PlayerCombatState.TurnNumber != 2)
      return;
    this.Flash();

...
// Type: MegaCrit.Sts2.Core.Models.Relics.FencingManual
...
public sealed class FencingManual : RelicModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new ForgeVar(10));
    }
  }

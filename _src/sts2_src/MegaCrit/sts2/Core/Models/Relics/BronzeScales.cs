...
// Type: MegaCrit.Sts2.Core.Models.Relics.BronzeScales
...
public sealed class BronzeScales : RelicModel
{
  ...
  public override async Task AfterRoomEntered(AbstractRoom room)
  {
    if (!(room is CombatRoom))
      return;
    this.Flash();
    ThornsPower thornsPower = await PowerCmd.Apply<ThornsPower>((PlayerChoiceContext) new ThrowingPlayerChoiceContext(), this.Owner.Creature, this.DynamicVars["ThornsPower"].BaseValue, this.Owner.Creature, (CardModel) null);
  }
}

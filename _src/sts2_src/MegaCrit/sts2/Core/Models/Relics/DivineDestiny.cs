...
// Type: MegaCrit.Sts2.Core.Models.Relics.DivineDestiny
...
public sealed class DivineDestiny : RelicModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new StarsVar(7));
    }
  }

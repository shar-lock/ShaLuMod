...
// Type: MegaCrit.Sts2.Core.Models.Relics.TungstenRod
...
public sealed class TungstenRod : RelicModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>(new DynamicVar("HpLossReduction", 1M));
    }
  }

...
// Type: MegaCrit.Sts2.Core.Models.Relics.DiamondDiadem
...
public sealed class DiamondDiadem : RelicModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new BlockVar(20M, ValueProp.Unpowered));
    }
  }
    ...
    ICombatState combatState)
  {
    ...
    BlurPower blurPower = await PowerCmd.Apply<BlurPower>((PlayerChoiceContext) new ThrowingPlayerChoiceContext(), this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) null);
  }
}

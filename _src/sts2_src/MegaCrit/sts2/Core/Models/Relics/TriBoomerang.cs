...
// Type: MegaCrit.Sts2.Core.Models.Relics.TriBoomerang
...
public sealed class TriBoomerang : RelicModel
{
  ...
  {
    get => HoverTipFactory.FromEnchantment<Instinct>();
  }
  ...
  public override async Task AfterObtained()
  {
    ...
    foreach (CardModel card in await CardSelectCmd.FromDeckForEnchantment(this.Owner, (EnchantmentModel) ModelDb.Enchantment<Instinct>(), 1, prefs))
    {

...
// Type: MegaCrit.Sts2.Core.Models.Relics.BoomingConch
...
public sealed class BoomingConch : RelicModel
{
  ...
  public override Decimal ModifyHandDraw(Player player, Decimal count)
  {
    ...
    return (currentRoom != null ? (currentRoom.RoomType != RoomType.Elite ? 1 : 0) : 1) != 0 ? count : count + (Decimal) this.DynamicVars.Cards.IntValue;
  }

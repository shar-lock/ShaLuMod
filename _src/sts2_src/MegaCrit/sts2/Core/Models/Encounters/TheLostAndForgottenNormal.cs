...
// Type: MegaCrit.Sts2.Core.Models.Encounters.TheLostAndForgottenNormal
...
public sealed class TheLostAndForgottenNormal : EncounterModel
{
  ...
  public override IEnumerable<MonsterModel> AllPossibleMonsters
  {
    get
    {
      ...
      {
        (MonsterModel) ModelDb.Monster<TheLost>(),
        (MonsterModel) ModelDb.Monster<TheForgotten>()
      });
    }
  }
  ...
  protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
  {
    ...
    {
      (ModelDb.Monster<TheLost>().ToMutable(), (string) null),
      (ModelDb.Monster<TheForgotten>().ToMutable(), (string) null)
    });
  }
}

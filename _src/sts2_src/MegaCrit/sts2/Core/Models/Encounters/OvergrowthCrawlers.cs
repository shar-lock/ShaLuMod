...
// Type: MegaCrit.Sts2.Core.Models.Encounters.OvergrowthCrawlers
...
public sealed class OvergrowthCrawlers : EncounterModel
{
  ...
  protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
  {
    ...
    {
      (ModelDb.Monster<ShrinkerBeetle>().ToMutable(), (string) null),
      (ModelDb.Monster<FuzzyWurmCrawler>().ToMutable(), (string) null)
    });
  }
}

...
// Type: MegaCrit.Sts2.Core.Models.Encounters.SnappingJaxfruitNormal
...
public sealed class SnappingJaxfruitNormal : EncounterModel
{
  ...
  public override IEnumerable<MonsterModel> AllPossibleMonsters
  {
    get
    {
      ...
      {
        (MonsterModel) ModelDb.Monster<SnappingJaxfruit>(),
        (MonsterModel) ModelDb.Monster<Flyconid>()
      });
    }
  }
  ...
  protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
  {
    ...
    {
      (ModelDb.Monster<SnappingJaxfruit>().ToMutable(), (string) null),

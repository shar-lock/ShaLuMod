...
// Type: MegaCrit.Sts2.Core.Models.Encounters.ScrollsOfBitingNormal
...
public sealed class ScrollsOfBitingNormal : EncounterModel
{
  ...
  protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
  {
    ...
    return (IReadOnlyList<(MonsterModel, string)>) new \u003C\u003Ez__ReadOnlyArray<(MonsterModel, string)>(new (MonsterModel, string)[4]
    {
      ...
      ((MonsterModel) mutable4, (string) null)
    });
  }
}

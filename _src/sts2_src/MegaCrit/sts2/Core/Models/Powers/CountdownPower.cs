...
// Type: MegaCrit.Sts2.Core.Models.Powers.CountdownPower
...
public sealed class CountdownPower : PowerModel
{
    ...
    ICombatState combatState)
  {
    ...
    if (target == null)
      return;
    DoomPower doomPower = await PowerCmd.Apply<DoomPower>((PlayerChoiceContext) new ThrowingPlayerChoiceContext(), target, (Decimal) this.Amount, this.Owner, (CardModel) null);
  }
}

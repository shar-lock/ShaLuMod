...
// Type: MegaCrit.Sts2.Core.Models.Powers.SneakyPower
...
public sealed class SneakyPower : PowerModel
{
  ...
  public override async Task AfterCardPlayed(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    if (cardPlay.Card.Owner.Creature == this.Owner || cardPlay.Card.Type != CardType.Attack)
      return;
    this.Flash();
    Decimal num = await CreatureCmd.GainBlock(this.Owner, (Decimal) this.Amount, ValueProp.Unpowered, (CardPlay) null, true);
  }
}

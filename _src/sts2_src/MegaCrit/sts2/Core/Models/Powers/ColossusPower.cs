...
// Type: MegaCrit.Sts2.Core.Models.Powers.ColossusPower
...
public sealed class ColossusPower : PowerModel
{
  ...
  public override Decimal ModifyDamageMultiplicative(
    ...
    CardPlay? cardPlay)
  {
    return target != this.Owner || !props.IsPoweredAttack() || dealer == null || !dealer.HasPower<VulnerablePower>() ? 1M : this.DynamicVars["DamageDecrease"].BaseValue;
  }

...
// Type: MegaCrit.Sts2.Core.Models.Monsters.Architect
...
public sealed class Architect : MonsterModel
{
  ...
  protected override MegaCrit.Sts2.Core.MonsterMoves.MonsterMoveStateMachine.MonsterMoveStateMachine GenerateMoveStateMachine()
  {
    ...
    MoveState initialState = new MoveState("NOTHING", (Func<IReadOnlyList<Creature>, Task>) (_ => Task.CompletedTask), new AbstractIntent[1]
    {

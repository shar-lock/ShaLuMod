...
// Type: MegaCrit.Sts2.Core.Models.Monsters.Mocks.MockIntangibleMonster
...
public sealed class MockIntangibleMonster : MonsterModel
{
  ...
  protected override MegaCrit.Sts2.Core.MonsterMoves.MonsterMoveStateMachine.MonsterMoveStateMachine GenerateMoveStateMachine()
  {
    ...
    MoveState initialState = new MoveState("INTANGIBLE", new Func<IReadOnlyList<Creature>, Task>(this.IntangibleMove), new AbstractIntent[1]
    {
      (AbstractIntent) new HiddenIntent()
    });
    MoveState moveState = new MoveState("NOTHING", new Func<IReadOnlyList<Creature>, Task>(this.NothingMove), new AbstractIntent[1]
    {
      (AbstractIntent) new HiddenIntent()
    });

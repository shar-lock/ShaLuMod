...
// Type: MegaCrit.Sts2.Core.Models.Cards.HighFive
...
public sealed class HighFive : CardModel
{
  ...
  protected override bool IsPlayable => !this.Owner.IsOstyMissing;
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      ...
      {
        (DynamicVar) new OstyDamageVar(11M, ValueProp.Move),

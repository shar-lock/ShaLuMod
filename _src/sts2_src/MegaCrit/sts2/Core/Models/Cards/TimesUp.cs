...
// Type: MegaCrit.Sts2.Core.Models.Cards.TimesUp
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlyArray<DynamicVar>(new DynamicVar[3]
      {
        ...
        (DynamicVar) new CalculatedDamageVar(ValueProp.Move).WithMultiplier((Func<CardModel, Creature, Decimal>) ((_, target) => (Decimal) (target != null ? target.GetPowerAmount<DoomPower>() : 0)))
      });
    }
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Flechettes
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlyArray<DynamicVar>(new DynamicVar[4]
      {
        ...
        (DynamicVar) new CalculatedVar("CalculatedHits").WithMultiplier((Func<CardModel, Creature, Decimal>) ((card, _) => (Decimal) PileType.Hand.GetPile(card.Owner).Cards.Count<CardModel>((Func<CardModel, bool>) (c => c.Type == CardType.Skill))))
      });
    }
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Blaze
...
public sealed class Blaze : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    StrengthPower strengthPower = await PowerCmd.Apply<StrengthPower>(choiceContext, cardPlay.Target, this.DynamicVars.Strength.BaseValue, this.Owner.Creature, (CardModel) this);
  }

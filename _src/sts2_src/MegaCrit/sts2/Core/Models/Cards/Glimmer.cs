...
// Type: MegaCrit.Sts2.Core.Models.Cards.Glimmer
...
public sealed class Glimmer : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    CardModel[] array = (await CardSelectCmd.FromHand(choiceContext, this.Owner, prefs, (Func<CardModel, bool>) null, (AbstractModel) this)).ToArray<CardModel>();
    if (array.Length == 0)
      return;
    IReadOnlyList<CardPileAddResult> cardPileAddResultList = await CardPileCmd.Add((IEnumerable<CardModel>) array, PileType.Draw, CardPilePosition.Top);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.ForbiddenGrimoire
...
public sealed class ForbiddenGrimoire : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    ForbiddenGrimoirePower forbiddenGrimoirePower = await PowerCmd.Apply<ForbiddenGrimoirePower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

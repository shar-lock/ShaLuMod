...
// Type: MegaCrit.Sts2.Core.Models.Cards.Begone
...
public sealed class Begone : CardModel
{
  ...
  protected override IEnumerable<IHoverTip> ExtraHoverTips
  {
    get
    {
      return (IEnumerable<IHoverTip>) new \u003C\u003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.FromCard<MinionStrike>(this.IsUpgraded));
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    if (original == null)
      return;
    CardModel card = (CardModel) this.CombatState.CreateCard<MinionStrike>(this.Owner);
    if (this.IsUpgraded)

...
// Type: MegaCrit.Sts2.Core.Models.Cards.BiasedCognition
...
public sealed class BiasedCognition : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      ...
      {
        (DynamicVar) new PowerVar<FocusPower>(4M),
        (DynamicVar) new PowerVar<BiasedCognitionPower>(1M)
      });
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    BiasedCognitionPower biasedCognitionPower = await PowerCmd.Apply<BiasedCognitionPower>(choiceContext, this.Owner.Creature, this.DynamicVars["BiasedCognitionPower"].BaseValue, this.Owner.Creature, (CardModel) this);
  }

  protected override void OnUpgrade() => this.DynamicVars["FocusPower"].UpgradeValueBy(1M);
}

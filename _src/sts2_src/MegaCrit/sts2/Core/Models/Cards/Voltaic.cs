...
// Type: MegaCrit.Sts2.Core.Models.Cards.Voltaic
...
public sealed class Voltaic : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlyArray<DynamicVar>(new DynamicVar[3]
      {
        ...
        (DynamicVar) new CalculatedVar("CalculatedChannels").WithMultiplier((Func<CardModel, Creature, Decimal>) ((card, _) => (Decimal) CombatManager.Instance.History.Entries.OfType<OrbChanneledEntry>().Count<OrbChanneledEntry>((Func<OrbChanneledEntry, bool>) (e => e.Actor.Player == card.Owner && e.Orb is LightningOrb))))
      });
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    int lightningChanneledCount = (int) ((CalculatedVar) this.DynamicVars["CalculatedChannels"]).Calculate(cardPlay.Target);

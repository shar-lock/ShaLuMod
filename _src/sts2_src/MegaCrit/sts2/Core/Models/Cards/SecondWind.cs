...
// Type: MegaCrit.Sts2.Core.Models.Cards.SecondWind
...
public sealed class SecondWind : CardModel
{
  ...
  {
    return PileType.Hand.GetPile(this.Owner).Cards.Where<CardModel>((Func<CardModel, bool>) (c => c.Type != CardType.Attack));
  }
}

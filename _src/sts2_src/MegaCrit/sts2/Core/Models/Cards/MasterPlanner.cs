...
// Type: MegaCrit.Sts2.Core.Models.Cards.MasterPlanner
...
public sealed class MasterPlanner : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    MasterPlannerPower masterPlannerPower = await PowerCmd.Apply<MasterPlannerPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

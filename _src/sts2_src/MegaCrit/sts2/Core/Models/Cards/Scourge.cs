...
// Type: MegaCrit.Sts2.Core.Models.Cards.Scourge
...
public sealed class Scourge : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      ...
      {
        (DynamicVar) new PowerVar<DoomPower>(13M),
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    DoomPower doomPower = await PowerCmd.Apply<DoomPower>(choiceContext, cardPlay.Target, this.DynamicVars.Doom.BaseValue, this.Owner.Creature, (CardModel) this);
    IEnumerable<CardModel> cardModels = await CardPileCmd.Draw(choiceContext, this.DynamicVars.Cards.BaseValue, this.Owner);
  }

  protected override void OnUpgrade()
  {
    this.DynamicVars.Doom.UpgradeValueBy(3M);

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Rage
...
public sealed class Rage : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    RagePower ragePower = await PowerCmd.Apply<RagePower>(choiceContext, this.Owner.Creature, this.DynamicVars["Power"].BaseValue, this.Owner.Creature, (CardModel) this);
  }

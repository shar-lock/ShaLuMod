...
// Type: MegaCrit.Sts2.Core.Models.Cards.Fuel
...
public sealed class Fuel : CardModel
{
  ...
  protected override IEnumerable<IHoverTip> ExtraHoverTips
  {
    get
    {
      return (IEnumerable<IHoverTip>) new \u003C\u003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.ForEnergy((CardModel) this));
    }
  }

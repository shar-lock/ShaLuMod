...
// Type: MegaCrit.Sts2.Core.Models.Cards.Debilitate
...
public sealed class Debilitate : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlyArray<DynamicVar>(new DynamicVar[2]
      {
        ...
        (DynamicVar) new PowerVar<DebilitatePower>(2M)
      });
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    DebilitatePower debilitatePower = await PowerCmd.Apply<DebilitatePower>(choiceContext, cardPlay.Target, this.DynamicVars["DebilitatePower"].BaseValue, this.Owner.Creature, (CardModel) this);
  }

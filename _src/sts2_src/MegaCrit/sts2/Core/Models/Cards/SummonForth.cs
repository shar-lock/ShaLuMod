...
// Type: MegaCrit.Sts2.Core.Models.Cards.SummonForth
...
public sealed class SummonForth : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new ForgeVar(8));
    }
  }
  ...
  protected override IEnumerable<IHoverTip> ExtraHoverTips
  {
    get
    {
      ...
      items.Add(HoverTipFactory.FromKeyword(CardKeyword.Retain));
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    IReadOnlyList<CardPileAddResult> cardPileAddResultList = await CardPileCmd.Add((IEnumerable<CardModel>) this.Owner.PlayerCombatState.AllCards.OfType<SovereignBlade>().Where<SovereignBlade>((Func<SovereignBlade, bool>) (c =>
    {

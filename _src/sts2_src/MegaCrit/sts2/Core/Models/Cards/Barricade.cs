...
// Type: MegaCrit.Sts2.Core.Models.Cards.Barricade
...
public sealed class Barricade : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    BarricadePower barricadePower = await PowerCmd.Apply<BarricadePower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

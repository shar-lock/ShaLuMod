...
// Type: MegaCrit.Sts2.Core.Models.Cards.AdaptiveStrike
...
public sealed class AdaptiveStrike : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    CardCmd.PreviewCardPileAdd(await CardPileCmd.AddGeneratedCardToCombat(clone, PileType.Discard, this.Owner), 1.5f);
  }

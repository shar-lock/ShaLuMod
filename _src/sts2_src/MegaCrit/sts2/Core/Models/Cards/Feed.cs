...
// Type: MegaCrit.Sts2.Core.Models.Cards.Feed
...
public sealed class Feed : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    AttackCommand attackCommand = await DamageCmd.Attack(this.DynamicVars.Damage.BaseValue).FromCard((CardModel) this, cardPlay).Targeting(cardPlay.Target).WithHitFx("vfx/vfx_bite", tmpSfx: "blunt_attack.mp3").Execute(choiceContext);
  ...
  protected override void OnUpgrade()
  {
    ...
    this.DynamicVars.MaxHp.UpgradeValueBy(1M);
  }
}

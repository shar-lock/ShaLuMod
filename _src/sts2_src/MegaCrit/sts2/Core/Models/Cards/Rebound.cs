...
// Type: MegaCrit.Sts2.Core.Models.Cards.Rebound
...
public sealed class Rebound : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    ReboundPower reboundPower = await PowerCmd.Apply<ReboundPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.FeedingFrenzy
...
public sealed class FeedingFrenzy : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    FeedingFrenzyPower feedingFrenzyPower = await PowerCmd.Apply<FeedingFrenzyPower>(choiceContext, this.Owner.Creature, baseValue, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.SpectrumShift
...
public sealed class SpectrumShift : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    SpectrumShiftPower spectrumShiftPower = await PowerCmd.Apply<SpectrumShiftPower>(choiceContext, this.Owner.Creature, this.DynamicVars.Cards.BaseValue, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.SetupStrike
...
public sealed class SetupStrike : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    SetupStrikePower setupStrikePower = await PowerCmd.Apply<SetupStrikePower>(choiceContext, this.Owner.Creature, this.DynamicVars.Strength.BaseValue, this.Owner.Creature, (CardModel) this);
  }

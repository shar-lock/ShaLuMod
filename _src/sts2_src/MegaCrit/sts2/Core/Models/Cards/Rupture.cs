...
// Type: MegaCrit.Sts2.Core.Models.Cards.Rupture
...
public sealed class Rupture : CardModel
{
  ...
  {
    RupturePower rupturePower = await PowerCmd.Apply<RupturePower>(choiceContext, this.Owner.Creature, this.DynamicVars.Strength.BaseValue, this.Owner.Creature, (CardModel) this);
  }

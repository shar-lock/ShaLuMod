...
// Type: MegaCrit.Sts2.Core.Models.Cards.MachineLearning
...
public sealed class MachineLearning : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    MachineLearningPower machineLearningPower = await PowerCmd.Apply<MachineLearningPower>(choiceContext, this.Owner.Creature, this.DynamicVars.Cards.BaseValue, this.Owner.Creature, (CardModel) this);
  }

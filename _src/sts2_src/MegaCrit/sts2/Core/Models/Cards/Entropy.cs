...
// Type: MegaCrit.Sts2.Core.Models.Cards.Entropy
...
public sealed class Entropy : CardModel
{
  ...
  {
    EntropyPower entropyPower = await PowerCmd.Apply<EntropyPower>(choiceContext, this.Owner.Creature, (Decimal) this.DynamicVars.Cards.IntValue, this.Owner.Creature, (CardModel) this);
  }

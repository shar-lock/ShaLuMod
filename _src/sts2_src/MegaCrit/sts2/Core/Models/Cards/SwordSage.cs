...
// Type: MegaCrit.Sts2.Core.Models.Cards.SwordSage
...
public sealed class SwordSage : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new PowerVar<SwordSagePower>(1M));
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    SwordSagePower swordSagePower = await PowerCmd.Apply<SwordSagePower>(choiceContext, this.Owner.Creature, this.DynamicVars["SwordSagePower"].BaseValue, this.Owner.Creature, (CardModel) this);
  }

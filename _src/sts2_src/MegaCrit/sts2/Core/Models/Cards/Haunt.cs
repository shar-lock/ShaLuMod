...
// Type: MegaCrit.Sts2.Core.Models.Cards.Haunt
...
public sealed class Haunt : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new HpLossVar(7M));
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    HauntPower hauntPower = await PowerCmd.Apply<HauntPower>(choiceContext, this.Owner.Creature, this.DynamicVars.HpLoss.BaseValue, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Wish
...
public sealed class Wish : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    CardModel card = (await CardSelectCmd.FromCombatPile(choiceContext, PileType.Draw.GetPile(this.Owner), this.Owner, prefs)).FirstOrDefault<CardModel>();
    if (card == null)
      return;

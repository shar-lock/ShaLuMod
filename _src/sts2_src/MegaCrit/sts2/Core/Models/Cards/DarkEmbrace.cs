...
// Type: MegaCrit.Sts2.Core.Models.Cards.DarkEmbrace
...
public sealed class DarkEmbrace : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    DarkEmbracePower darkEmbracePower = await PowerCmd.Apply<DarkEmbracePower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

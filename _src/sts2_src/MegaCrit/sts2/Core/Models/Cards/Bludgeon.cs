...
// Type: MegaCrit.Sts2.Core.Models.Cards.Bludgeon
...
public sealed class Bludgeon : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new DamageVar(32M, ValueProp.Move));
    }
  }

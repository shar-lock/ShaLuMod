...
// Type: MegaCrit.Sts2.Core.Models.Cards.Veilpiercer
...
public sealed class Veilpiercer : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    VeilpiercerPower veilpiercerPower = await PowerCmd.Apply<VeilpiercerPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.HiddenDaggers
...
public sealed class HiddenDaggers : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    IEnumerable<CardModel> inHand = await Shiv.CreateInHand(this.Owner, this.DynamicVars["Shivs"].IntValue, this.CombatState);
    if (!this.IsUpgraded)
      return;

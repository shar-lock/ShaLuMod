...
// Type: MegaCrit.Sts2.Core.Models.Cards.BlightStrike
...
public sealed class BlightStrike : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    DoomPower doomPower = await PowerCmd.Apply<DoomPower>(choiceContext, cardPlay.Target, (Decimal) (await DamageCmd.Attack(this.DynamicVars.Damage.BaseValue).FromCard((CardModel) this, cardPlay).Targeting(cardPlay.Target).WithHitFx("vfx/vfx_attack_slash").Execute(choiceContext)).Results.SelectMany<List<DamageResult>, DamageResult>((Func<List<DamageResult>, IEnumerable<DamageResult>>) (r => (IEnumerable<DamageResult>) r)).Sum<DamageResult>((Func<DamageResult, int>) (r => r.TotalDamage)), this.Owner.Creature, (CardModel) this);
  }

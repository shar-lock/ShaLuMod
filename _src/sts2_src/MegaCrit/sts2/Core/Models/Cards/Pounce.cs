...
// Type: MegaCrit.Sts2.Core.Models.Cards.Pounce
...
public sealed class Pounce : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    FreeSkillPower freeSkillPower = await PowerCmd.Apply<FreeSkillPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

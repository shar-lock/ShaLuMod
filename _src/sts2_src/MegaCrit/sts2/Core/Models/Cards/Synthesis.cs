...
// Type: MegaCrit.Sts2.Core.Models.Cards.Synthesis
...
public sealed class Synthesis : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    FreePowerPower freePowerPower = await PowerCmd.Apply<FreePowerPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

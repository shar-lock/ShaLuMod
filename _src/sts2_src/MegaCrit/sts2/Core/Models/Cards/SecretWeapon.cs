...
// Type: MegaCrit.Sts2.Core.Models.Cards.SecretWeapon
...
public sealed class SecretWeapon : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    CardModel card = (await CardSelectCmd.FromCombatPile(choiceContext, PileType.Draw.GetPile(this.Owner), this.Owner, prefs, (Func<CardModel, bool>) (c => c.Type == CardType.Attack))).FirstOrDefault<CardModel>();
    if (card == null)
      return;

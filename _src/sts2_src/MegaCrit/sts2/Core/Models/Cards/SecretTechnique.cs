...
// Type: MegaCrit.Sts2.Core.Models.Cards.SecretTechnique
...
public sealed class SecretTechnique : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    CardModel card = (await CardSelectCmd.FromCombatPile(choiceContext, PileType.Draw.GetPile(this.Owner), this.Owner, prefs, (Func<CardModel, bool>) (c => c.Type == CardType.Skill))).FirstOrDefault<CardModel>();
    if (card == null)
      return;

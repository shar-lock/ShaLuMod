...
// Type: MegaCrit.Sts2.Core.Models.Cards.Whistle
...
public sealed class Whistle : CardModel
{
  ...
  protected override IEnumerable<IHoverTip> ExtraHoverTips
  {
    get
    {
      return (IEnumerable<IHoverTip>) new \u003C\u003Ez__ReadOnlySingleElementList<IHoverTip>((IHoverTip) StunIntent.GetStaticHoverTip());
    }
  }
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new DamageVar(33M, ValueProp.Move));
    }
  }

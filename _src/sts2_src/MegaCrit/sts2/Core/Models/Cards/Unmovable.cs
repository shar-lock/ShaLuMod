...
// Type: MegaCrit.Sts2.Core.Models.Cards.Unmovable
...
public sealed class Unmovable : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    UnmovablePower unmovablePower = await PowerCmd.Apply<UnmovablePower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

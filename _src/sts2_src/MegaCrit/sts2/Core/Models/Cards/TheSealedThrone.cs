...
// Type: MegaCrit.Sts2.Core.Models.Cards.TheSealedThrone
...
public sealed class TheSealedThrone : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    TheSealedThronePower sealedThronePower = await PowerCmd.Apply<TheSealedThronePower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

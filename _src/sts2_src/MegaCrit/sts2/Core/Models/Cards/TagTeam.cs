...
// Type: MegaCrit.Sts2.Core.Models.Cards.TagTeam
...
public sealed class TagTeam : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    TagTeamPower tagTeamPower = await PowerCmd.Apply<TagTeamPower>(choiceContext, cardPlay.Target, 1M, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Tracking
...
public sealed class Tracking : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    TrackingPower trackingPower = await PowerCmd.Apply<TrackingPower>(choiceContext, this.Owner.Creature, 50M, this.Owner.Creature, (CardModel) this);
  }

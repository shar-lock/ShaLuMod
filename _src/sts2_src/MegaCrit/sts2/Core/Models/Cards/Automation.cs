...
// Type: MegaCrit.Sts2.Core.Models.Cards.Automation
...
public sealed class Automation : CardModel
{
  ...
  {
    AutomationPower automationPower = await PowerCmd.Apply<AutomationPower>(choiceContext, this.Owner.Creature, (Decimal) this.DynamicVars.Energy.IntValue, this.Owner.Creature, (CardModel) this);
  }

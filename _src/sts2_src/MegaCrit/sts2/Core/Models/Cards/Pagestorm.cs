...
// Type: MegaCrit.Sts2.Core.Models.Cards.Pagestorm
...
public sealed class Pagestorm : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    PagestormPower pagestormPower = await PowerCmd.Apply<PagestormPower>(choiceContext, this.Owner.Creature, this.DynamicVars.Cards.BaseValue, this.Owner.Creature, (CardModel) this);
  }

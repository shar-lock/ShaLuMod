...
// Type: MegaCrit.Sts2.Core.Models.Cards.ConsumingShadow
...
public sealed class ConsumingShadow : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlyArray<DynamicVar>(new DynamicVar[2]
      {
        ...
        (DynamicVar) new PowerVar<ConsumingShadowPower>(1M)
      });
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    ConsumingShadowPower consumingShadowPower = await PowerCmd.Apply<ConsumingShadowPower>(choiceContext, this.Owner.Creature, this.DynamicVars["ConsumingShadowPower"].BaseValue, this.Owner.Creature, (CardModel) this);
  }

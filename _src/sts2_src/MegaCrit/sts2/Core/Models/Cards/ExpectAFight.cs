...
// Type: MegaCrit.Sts2.Core.Models.Cards.ExpectAFight
...
public sealed class ExpectAFight : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlyArray<DynamicVar>(new DynamicVar[4]
      {
        ...
        (DynamicVar) new CalculatedVar("CalculatedEnergy").WithMultiplier((Func<CardModel, Creature, Decimal>) ((card, _) => (Decimal) PileType.Hand.GetPile(card.Owner).Cards.Count<CardModel>((Func<CardModel, bool>) (c => c.Type == CardType.Attack))))
      });
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    await PlayerCmd.GainEnergy(((CalculatedVar) this.DynamicVars["CalculatedEnergy"]).Calculate(cardPlay.Target), this.Owner);
  }

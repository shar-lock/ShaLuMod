...
// Type: MegaCrit.Sts2.Core.Models.Cards.PiercingWail
...
public sealed class PiercingWail : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>(new DynamicVar("StrengthLoss", 6M));
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    {
      PiercingWailPower piercingWailPower = await PowerCmd.Apply<PiercingWailPower>(choiceContext, hittableEnemy, this.DynamicVars["StrengthLoss"].BaseValue, this.Owner.Creature, (CardModel) this);
    }
  }

  protected override void OnUpgrade() => this.DynamicVars["StrengthLoss"].UpgradeValueBy(2M);
}

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Tank
...
public sealed class Tank : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    TankPower tankPower = await PowerCmd.Apply<TankPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

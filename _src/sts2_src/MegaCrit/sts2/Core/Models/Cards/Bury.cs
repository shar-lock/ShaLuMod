...
// Type: MegaCrit.Sts2.Core.Models.Cards.Bury
...
public sealed class Bury : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new DamageVar(52M, ValueProp.Move));
    }
  }

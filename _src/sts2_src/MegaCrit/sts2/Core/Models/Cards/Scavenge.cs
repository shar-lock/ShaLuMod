...
// Type: MegaCrit.Sts2.Core.Models.Cards.Scavenge
...
public sealed class Scavenge : CardModel
{
  ...
  {
    CardModel card = (await CardSelectCmd.FromHand(choiceContext, this.Owner, new CardSelectorPrefs(CardSelectorPrefs.ExhaustSelectionPrompt, 1), (Func<CardModel, bool>) null, (AbstractModel) this)).FirstOrDefault<CardModel>();
    if (card != null)

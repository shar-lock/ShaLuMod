...
// Type: MegaCrit.Sts2.Core.Models.Cards.Scare
...
public sealed class Scare : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    {
      WeakPower weakPower = await PowerCmd.Apply<WeakPower>(choiceContext, hittableEnemy, 1M, this.Owner.Creature, (CardModel) this);
    }
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Vicious
...
public sealed class Vicious : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    ViciousPower viciousPower = await PowerCmd.Apply<ViciousPower>(choiceContext, this.Owner.Creature, this.DynamicVars.Cards.BaseValue, this.Owner.Creature, (CardModel) this);
  }

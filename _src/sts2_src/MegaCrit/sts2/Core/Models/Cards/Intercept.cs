...
// Type: MegaCrit.Sts2.Core.Models.Cards.Intercept
...
public sealed class Intercept : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    CoveredPower coveredPower = await PowerCmd.Apply<CoveredPower>(choiceContext, cardPlay.Target, 1M, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Devastate
...
public sealed class Devastate : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new DamageVar(35M, ValueProp.Move));
    }
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Hotfix
...
public sealed class Hotfix : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>((DynamicVar) new PowerVar<FocusPower>(2M));
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    HotfixPower hotfixPower = await PowerCmd.Apply<HotfixPower>(choiceContext, this.Owner.Creature, this.DynamicVars["FocusPower"].BaseValue, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Predator
...
public sealed class Predator : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    DrawCardsNextTurnPower cardsNextTurnPower = await PowerCmd.Apply<DrawCardsNextTurnPower>(choiceContext, this.Owner.Creature, 2M, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Resonance
...
public sealed class Resonance : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    int intValue = this.DynamicVars["StrengthPower"].IntValue;
    StrengthPower strengthPower1 = await PowerCmd.Apply<StrengthPower>(choiceContext, this.Owner.Creature, (Decimal) intValue, this.Owner.Creature, (CardModel) this);
    foreach (Creature hittableEnemy in (IEnumerable<Creature>) this.CombatState.HittableEnemies)
    {
      StrengthPower strengthPower2 = await PowerCmd.Apply<StrengthPower>(choiceContext, hittableEnemy, -1M, this.Owner.Creature, (CardModel) this);
    }
  }

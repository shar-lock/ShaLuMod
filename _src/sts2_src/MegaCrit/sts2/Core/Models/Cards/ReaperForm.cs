...
// Type: MegaCrit.Sts2.Core.Models.Cards.ReaperForm
...
public sealed class ReaperForm : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    ReaperFormPower reaperFormPower = await PowerCmd.Apply<ReaperFormPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

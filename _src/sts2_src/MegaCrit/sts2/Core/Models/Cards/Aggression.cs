...
// Type: MegaCrit.Sts2.Core.Models.Cards.Aggression
...
public sealed class Aggression : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    AggressionPower aggressionPower = await PowerCmd.Apply<AggressionPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Monologue
...
public sealed class Monologue : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    MonologuePower monologuePower = await PowerCmd.Apply<MonologuePower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
    if (monologuePower == null)
      return;
    monologuePower.DynamicVars.Strength.BaseValue = this.DynamicVars["Power"].BaseValue;
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Shadowmeld
...
public sealed class Shadowmeld : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    ShadowmeldPower shadowmeldPower = await PowerCmd.Apply<ShadowmeldPower>(choiceContext, this.Owner.Creature, this.DynamicVars["Power"].BaseValue, this.Owner.Creature, (CardModel) this);
  }

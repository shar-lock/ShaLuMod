...
// Type: MegaCrit.Sts2.Core.Models.Cards.Spur
...
public sealed class Spur : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      ...
      {
        (DynamicVar) new SummonVar(3M),
        (DynamicVar) new HealVar(5M)
      });
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    await CreatureCmd.Heal(this.Owner.Osty, this.DynamicVars.Heal.BaseValue);
  }

  protected override void OnUpgrade()
  {
    this.DynamicVars.Summon.UpgradeValueBy(2M);

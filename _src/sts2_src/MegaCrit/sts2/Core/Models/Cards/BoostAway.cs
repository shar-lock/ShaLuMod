...
// Type: MegaCrit.Sts2.Core.Models.Cards.BoostAway
...
public sealed class BoostAway : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    CardCmd.PreviewCardPileAdd(await CardPileCmd.AddGeneratedCardToCombat((CardModel) this.CombatState.CreateCard<Dazed>(this.Owner), PileType.Discard, this.Owner));
    await Cmd.Wait(0.5f);
  }

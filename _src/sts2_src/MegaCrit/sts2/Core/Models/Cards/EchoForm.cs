...
// Type: MegaCrit.Sts2.Core.Models.Cards.EchoForm
...
public sealed class EchoForm : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      return (IEnumerable<DynamicVar>) new \u003C\u003Ez__ReadOnlySingleElementList<DynamicVar>(new DynamicVar(nameof (EchoForm), 1M));
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    EchoFormPower echoFormPower = await PowerCmd.Apply<EchoFormPower>(choiceContext, this.Owner.Creature, this.DynamicVars[nameof (EchoForm)].BaseValue, this.Owner.Creature, (CardModel) this);
  }

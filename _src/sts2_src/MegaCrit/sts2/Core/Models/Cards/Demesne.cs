...
// Type: MegaCrit.Sts2.Core.Models.Cards.Demesne
...
public sealed class Demesne : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    DemesnePower demesnePower = await PowerCmd.Apply<DemesnePower>(choiceContext, this.Owner.Creature, this.DynamicVars.Cards.BaseValue, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.PaleBlueDot
...
public sealed class PaleBlueDot : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    PaleBlueDotPower paleBlueDotPower = await PowerCmd.Apply<PaleBlueDotPower>(choiceContext, this.Owner.Creature, this.DynamicVars.Cards.BaseValue, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.NecroMastery
...
public sealed class NecroMastery : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    NecroMasteryPower necroMasteryPower = await PowerCmd.Apply<NecroMasteryPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

  protected override void OnUpgrade() => this.DynamicVars.Summon.UpgradeValueBy(3M);
}

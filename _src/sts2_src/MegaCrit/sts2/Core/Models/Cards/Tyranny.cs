...
// Type: MegaCrit.Sts2.Core.Models.Cards.Tyranny
...
public sealed class Tyranny : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    TyrannyPower tyrannyPower = await PowerCmd.Apply<TyrannyPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

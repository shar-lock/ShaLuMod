...
// Type: MegaCrit.Sts2.Core.Models.Cards.FeelNoPain
...
public sealed class FeelNoPain : CardModel
{
  ...
  {
    FeelNoPainPower feelNoPainPower = await PowerCmd.Apply<FeelNoPainPower>(choiceContext, this.Owner.Creature, this.DynamicVars["Power"].BaseValue, this.Owner.Creature, (CardModel) this);
  }

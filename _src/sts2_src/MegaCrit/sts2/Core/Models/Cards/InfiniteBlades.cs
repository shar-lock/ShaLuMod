...
// Type: MegaCrit.Sts2.Core.Models.Cards.InfiniteBlades
...
public sealed class InfiniteBlades : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    InfiniteBladesPower infiniteBladesPower = await PowerCmd.Apply<InfiniteBladesPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

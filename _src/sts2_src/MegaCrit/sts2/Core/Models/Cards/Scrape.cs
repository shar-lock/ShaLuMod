...
// Type: MegaCrit.Sts2.Core.Models.Cards.Scrape
...
public sealed class Scrape : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    await CardCmd.Discard(choiceContext, (await CardPileCmd.Draw(choiceContext, (Decimal) this.DynamicVars.Cards.IntValue, this.Owner)).Where<CardModel>((Func<CardModel, bool>) (c => c.EnergyCost.GetWithModifiers(CostModifiers.All) != 0 || c.EnergyCost.CostsX)));
  }

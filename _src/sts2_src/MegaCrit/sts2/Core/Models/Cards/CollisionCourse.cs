...
// Type: MegaCrit.Sts2.Core.Models.Cards.CollisionCourse
...
public sealed class CollisionCourse : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    CardPileAddResult combat = await CardPileCmd.AddGeneratedCardToCombat((CardModel) this.CombatState.CreateCard<Debris>(this.Owner), PileType.Hand, this.Owner);
    await Cmd.Wait(0.5f);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Reave
...
public sealed class Reave : CardModel
{
  ...
  protected override IEnumerable<IHoverTip> ExtraHoverTips
  {
    get
    {
      return (IEnumerable<IHoverTip>) new \u003C\u003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.FromCard<Soul>(this.IsUpgraded));
    }
  }
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    IEnumerable<Soul> cards = Soul.Create(this.Owner, this.DynamicVars.Cards.IntValue, this.CombatState);
    if (this.IsUpgraded)
    {

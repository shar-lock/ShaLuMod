...
// Type: MegaCrit.Sts2.Core.Models.Cards.GammaBlast
...
public sealed class GammaBlast : CardModel
{
  ...
  protected override IEnumerable<DynamicVar> CanonicalVars
  {
    get
    {
      ...
      {
        (DynamicVar) new DamageVar(13M, ValueProp.Move),
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    AttackCommand attackCommand = await DamageCmd.Attack(this.DynamicVars.Damage.BaseValue).FromCard((CardModel) this, cardPlay).Targeting(cardPlay.Target).WithHitFx("vfx/vfx_giant_horizontal_slash").Execute(choiceContext);

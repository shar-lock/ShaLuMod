...
// Type: MegaCrit.Sts2.Core.Models.Cards.CallOfTheVoid
...
public sealed class CallOfTheVoid : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    CallOfTheVoidPower callOfTheVoidPower = await PowerCmd.Apply<CallOfTheVoidPower>(choiceContext, this.Owner.Creature, this.DynamicVars.Cards.BaseValue, this.Owner.Creature, (CardModel) this);
  }

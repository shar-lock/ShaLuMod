...
// Type: MegaCrit.Sts2.Core.Models.Cards.Juggling
...
public sealed class Juggling : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    JugglingPower jugglingPower = await PowerCmd.Apply<JugglingPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.Shroud
...
public sealed class Shroud : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    ShroudPower shroudPower = await PowerCmd.Apply<ShroudPower>(choiceContext, this.Owner.Creature, this.DynamicVars.Block.BaseValue, this.Owner.Creature, (CardModel) this);
  }

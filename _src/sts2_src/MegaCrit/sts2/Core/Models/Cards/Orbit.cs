...
// Type: MegaCrit.Sts2.Core.Models.Cards.Orbit
...
public sealed class Orbit : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    OrbitPower orbitPower = await PowerCmd.Apply<OrbitPower>(choiceContext, this.Owner.Creature, this.DynamicVars.Energy.BaseValue, this.Owner.Creature, (CardModel) this);
  }

...
// Type: MegaCrit.Sts2.Core.Models.Cards.BeaconOfHope
...
public sealed class BeaconOfHope : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    BeaconOfHopePower beaconOfHopePower = await PowerCmd.Apply<BeaconOfHopePower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

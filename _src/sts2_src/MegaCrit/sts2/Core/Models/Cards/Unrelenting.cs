...
// Type: MegaCrit.Sts2.Core.Models.Cards.Unrelenting
...
public sealed class Unrelenting : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    FreeAttackPower freeAttackPower = await PowerCmd.Apply<FreeAttackPower>(choiceContext, this.Owner.Creature, 1M, this.Owner.Creature, (CardModel) this);
  }

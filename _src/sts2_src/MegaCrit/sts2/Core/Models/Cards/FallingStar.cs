...
// Type: MegaCrit.Sts2.Core.Models.Cards.FallingStar
...
public sealed class FallingStar : CardModel
{
  ...
  protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
  {
    ...
    AttackCommand attackCommand = await DamageCmd.Attack(this.DynamicVars.Damage.BaseValue).FromCard((CardModel) this, cardPlay).Targeting(cardPlay.Target).WithHitFx("vfx/vfx_starry_impact", "blunt_attack.mp3").Execute(choiceContext);

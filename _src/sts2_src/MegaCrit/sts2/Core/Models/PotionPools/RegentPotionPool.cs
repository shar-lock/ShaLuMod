...
// Type: MegaCrit.Sts2.Core.Models.PotionPools.RegentPotionPool
...
public sealed class RegentPotionPool : PotionPoolModel
{
  ...
  {
    return (IEnumerable<PotionModel>) Regent4Epoch.Potions;
  }

  public override IEnumerable<PotionModel> GetUnlockedPotions(UnlockState unlockState)
  {
    return !unlockState.IsEpochRevealed<Regent4Epoch>() ? (IEnumerable<PotionModel>) Array.Empty<PotionModel>() : this.GenerateAllPotions();
  }
}

...
// Type: MegaCrit.Sts2.Core.Models.PotionPools.NecrobinderPotionPool
...
public sealed class NecrobinderPotionPool : PotionPoolModel
{
  ...
  {
    return (IEnumerable<PotionModel>) Necrobinder4Epoch.Potions;
  }

  public override IEnumerable<PotionModel> GetUnlockedPotions(UnlockState unlockState)
  {
    return !unlockState.IsEpochRevealed<Necrobinder4Epoch>() ? (IEnumerable<PotionModel>) Array.Empty<PotionModel>() : this.GenerateAllPotions();
  }
}

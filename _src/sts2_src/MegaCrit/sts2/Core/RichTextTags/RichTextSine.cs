...
// Type: MegaCrit.Sts2.Core.RichTextTags.RichTextSine
...
public class RichTextSine : AbstractMegaRichTextEffect
{
  ...
  public override bool _ProcessCustomFX(CharFXTransform charFx)
  {
    ...
    float num = 0.8f * Mathf.Sin((float) ((charFx.ElapsedTime * 1.5 + (double) charFx.RelativeIndex * 0.10000000149011612) * 3.1415927410125732 * 2.0 * 0.5));
    CharFXTransform charFxTransform = charFx;
    charFxTransform.Offset = Vector2.op_Addition(charFxTransform.Offset, new Vector2(0.0f, num));
    Variant variant;
  ...
  List<MethodInfo> GetGodotMethodList()
  {
    ...
    {
      new MethodInfo(RichTextSine.MethodName._ProcessCustomFX, new PropertyInfo((Variant.Type) 1L, StringName.op_Implicit(""), (PropertyHint) 0L, "", (PropertyUsageFlags) 6L, false), (MethodFlags) 1L, new List<PropertyInfo>()
      {
  ...
  {
    if (!StringName.op_Equality(ref method, RichTextSine.MethodName._ProcessCustomFX) || ((NativeVariantPtrArgs) ref args).Count != 1)
  ...
  {
    return StringName.op_Equality(ref method, RichTextSine.MethodName._ProcessCustomFX) || base.HasGodotClassMethod(in method);
  }
  ...
  {
    if (!StringName.op_Equality(ref name, RichTextSine.PropertyName.bbcode))
  ...
  internal new static List<PropertyInfo> GetGodotPropertyList()
  {
    ...
    {
      new PropertyInfo((Variant.Type) 4L, RichTextSine.PropertyName.bbcode, (PropertyHint) 0L, "", (PropertyUsageFlags) 4096L /*0x1000*/, false),
      new PropertyInfo((Variant.Type) 4L, RichTextSine.PropertyName.Bbcode, (PropertyHint) 0L, "", (PropertyUsageFlags) 4096L /*0x1000*/, false)
    };
  }
  ...
  protected override void SaveGodotObjectData(GodotSerializationInfo info)
  {
    ...
    info.AddProperty(RichTextSine.PropertyName.bbcode, Variant.From<string>(ref this.bbcode));
  }
  ...
  protected override void RestoreGodotObjectData(GodotSerializationInfo info)
  {
    ...
    Variant variant;
    if (!info.TryGetProperty(RichTextSine.PropertyName.bbcode, ref variant))
      return;

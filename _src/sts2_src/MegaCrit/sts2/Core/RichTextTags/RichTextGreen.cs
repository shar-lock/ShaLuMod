...
// Type: MegaCrit.Sts2.Core.RichTextTags.RichTextGreen
...
public class RichTextGreen : AbstractMegaRichTextEffect
{
  ...
  List<MethodInfo> GetGodotMethodList()
  {
    ...
    {
      new MethodInfo(RichTextGreen.MethodName._ProcessCustomFX, new PropertyInfo((Variant.Type) 1L, StringName.op_Implicit(""), (PropertyHint) 0L, "", (PropertyUsageFlags) 6L, false), (MethodFlags) 1L, new List<PropertyInfo>()
      {
  ...
  {
    if (!StringName.op_Equality(ref method, RichTextGreen.MethodName._ProcessCustomFX) || ((NativeVariantPtrArgs) ref args).Count != 1)
  ...
  {
    return StringName.op_Equality(ref method, RichTextGreen.MethodName._ProcessCustomFX) || base.HasGodotClassMethod(in method);
  }
  ...
  {
    if (!StringName.op_Equality(ref name, RichTextGreen.PropertyName.bbcode))
  ...
  internal new static List<PropertyInfo> GetGodotPropertyList()
  {
    ...
    {
      new PropertyInfo((Variant.Type) 4L, RichTextGreen.PropertyName.bbcode, (PropertyHint) 0L, "", (PropertyUsageFlags) 4096L /*0x1000*/, false),
      new PropertyInfo((Variant.Type) 4L, RichTextGreen.PropertyName.Bbcode, (PropertyHint) 0L, "", (PropertyUsageFlags) 4096L /*0x1000*/, false)
    };
  }
  ...
  protected override void SaveGodotObjectData(GodotSerializationInfo info)
  {
    ...
    info.AddProperty(RichTextGreen.PropertyName.bbcode, Variant.From<string>(ref this.bbcode));
  }
  ...
  protected override void RestoreGodotObjectData(GodotSerializationInfo info)
  {
    ...
    Variant variant;
    if (!info.TryGetProperty(RichTextGreen.PropertyName.bbcode, ref variant))
      return;

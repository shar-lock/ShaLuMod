...
// Type: MegaCrit.Sts2.Core.RichTextTags.RichTextPink
...
public class RichTextPink : AbstractMegaRichTextEffect
{
  ...
  List<MethodInfo> GetGodotMethodList()
  {
    ...
    {
      new MethodInfo(RichTextPink.MethodName._ProcessCustomFX, new PropertyInfo((Variant.Type) 1L, StringName.op_Implicit(""), (PropertyHint) 0L, "", (PropertyUsageFlags) 6L, false), (MethodFlags) 1L, new List<PropertyInfo>()
      {
  ...
  {
    if (!StringName.op_Equality(ref method, RichTextPink.MethodName._ProcessCustomFX) || ((NativeVariantPtrArgs) ref args).Count != 1)
  ...
  {
    return StringName.op_Equality(ref method, RichTextPink.MethodName._ProcessCustomFX) || base.HasGodotClassMethod(in method);
  }
  ...
  {
    if (!StringName.op_Equality(ref name, RichTextPink.PropertyName.bbcode))
  ...
  internal new static List<PropertyInfo> GetGodotPropertyList()
  {
    ...
    {
      new PropertyInfo((Variant.Type) 4L, RichTextPink.PropertyName.bbcode, (PropertyHint) 0L, "", (PropertyUsageFlags) 4096L /*0x1000*/, false),
      new PropertyInfo((Variant.Type) 4L, RichTextPink.PropertyName.Bbcode, (PropertyHint) 0L, "", (PropertyUsageFlags) 4096L /*0x1000*/, false)
    };
  }
  ...
  protected override void SaveGodotObjectData(GodotSerializationInfo info)
  {
    ...
    info.AddProperty(RichTextPink.PropertyName.bbcode, Variant.From<string>(ref this.bbcode));
  }
  ...
  protected override void RestoreGodotObjectData(GodotSerializationInfo info)
  {
    ...
    Variant variant;
    if (!info.TryGetProperty(RichTextPink.PropertyName.bbcode, ref variant))
      return;

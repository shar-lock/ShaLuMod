...
// Type: MegaCrit.Sts2.Core.RichTextTags.RichTextRed
...
public class RichTextRed : AbstractMegaRichTextEffect
{
  ...
  List<MethodInfo> GetGodotMethodList()
  {
    ...
    {
      new MethodInfo(RichTextRed.MethodName._ProcessCustomFX, new PropertyInfo((Variant.Type) 1L, StringName.op_Implicit(""), (PropertyHint) 0L, "", (PropertyUsageFlags) 6L, false), (MethodFlags) 1L, new List<PropertyInfo>()
      {
  ...
  {
    if (!StringName.op_Equality(ref method, RichTextRed.MethodName._ProcessCustomFX) || ((NativeVariantPtrArgs) ref args).Count != 1)
  ...
  {
    return StringName.op_Equality(ref method, RichTextRed.MethodName._ProcessCustomFX) || base.HasGodotClassMethod(in method);
  }
  ...
  {
    if (!StringName.op_Equality(ref name, RichTextRed.PropertyName.bbcode))
  ...
  internal new static List<PropertyInfo> GetGodotPropertyList()
  {
    ...
    {
      new PropertyInfo((Variant.Type) 4L, RichTextRed.PropertyName.bbcode, (PropertyHint) 0L, "", (PropertyUsageFlags) 4096L /*0x1000*/, false),
      new PropertyInfo((Variant.Type) 4L, RichTextRed.PropertyName.Bbcode, (PropertyHint) 0L, "", (PropertyUsageFlags) 4096L /*0x1000*/, false)
    };
  }
  ...
  protected override void SaveGodotObjectData(GodotSerializationInfo info)
  {
    ...
    info.AddProperty(RichTextRed.PropertyName.bbcode, Variant.From<string>(ref this.bbcode));
  }
  ...
  protected override void RestoreGodotObjectData(GodotSerializationInfo info)
  {
    ...
    Variant variant;
    if (!info.TryGetProperty(RichTextRed.PropertyName.bbcode, ref variant))
      return;

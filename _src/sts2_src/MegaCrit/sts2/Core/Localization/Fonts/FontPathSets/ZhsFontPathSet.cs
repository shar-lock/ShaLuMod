...
// Type: MegaCrit.Sts2.Core.Localization.Fonts.FontPathSets.ZhsFontPathSet
  ...
  public override string GetPath(FontType type)
  {
    switch (type)
    {
      case FontType.Regular:
        return "res://themes/fonts/zhs/noto_sans_mono_cjksc_regular_shared.tres";
      case FontType.Bold:
        return "res://themes/fonts/zhs/source_han_serif_sc_bold_shared.tres";
      case FontType.Italic:
        return "res://themes/fonts/zhs/source_han_serif_sc_medium_shared.tres";
      default:

...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Regent6Epoch
...
public class Regent6Epoch : EpochModel
{
  ...
  public static List<RelicModel> Relics
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (RelicModel) ModelDb.Relic<Regalite>();
      int num2 = num1 + 1;
      span[num2] = (RelicModel) ModelDb.Relic<MiniRegent>();
      int num3 = num2 + 1;
      span[num3] = (RelicModel) ModelDb.Relic<OrangeDough>();
      return relics;
    }
  }

  public override string UnlockText => this.CreateRelicUnlockText(Regent6Epoch.Relics);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueRelicUnlock(Regent6Epoch.Relics);
  }
}

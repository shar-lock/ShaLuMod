...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Potion1Epoch
...
public class Potion1Epoch : EpochModel
{
  ...
  public static List<PotionModel> Potions
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (PotionModel) ModelDb.Potion<BeetleJuice>();
      int num2 = num1 + 1;
      span[num2] = (PotionModel) ModelDb.Potion<MazalethsGift>();
      int num3 = num2 + 1;
      span[num3] = (PotionModel) ModelDb.Potion<DropletOfPrecognition>();
      return potions;
    }
  }

  public override string UnlockText => this.CreatePotionUnlockText(Potion1Epoch.Potions);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueuePotionUnlock(Potion1Epoch.Potions);
  }
}

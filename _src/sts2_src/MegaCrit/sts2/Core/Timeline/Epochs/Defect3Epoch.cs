...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Defect3Epoch
...
public class Defect3Epoch : EpochModel
{
  ...
  public static List<RelicModel> Relics
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (RelicModel) ModelDb.Relic<DataDisk>();
      int num2 = num1 + 1;
      span[num2] = (RelicModel) ModelDb.Relic<SymbioticVirus>();
      int num3 = num2 + 1;
      span[num3] = (RelicModel) ModelDb.Relic<Metronome>();
      return relics;
    }
  }

  public override string UnlockText => this.CreateRelicUnlockText(Defect3Epoch.Relics);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueRelicUnlock(Defect3Epoch.Relics);
  }
}

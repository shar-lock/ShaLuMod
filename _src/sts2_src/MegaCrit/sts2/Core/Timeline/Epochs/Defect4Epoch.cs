...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Defect4Epoch
...
public class Defect4Epoch : EpochModel
{
  ...
  public static List<PotionModel> Potions
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (PotionModel) ModelDb.Potion<FocusPotion>();
      int num2 = num1 + 1;
      span[num2] = (PotionModel) ModelDb.Potion<EssenceOfDarkness>();
      int num3 = num2 + 1;
      span[num3] = (PotionModel) ModelDb.Potion<PotionOfCapacity>();
      return potions;
    }
  }

  public override string UnlockText => this.CreatePotionUnlockText(Defect4Epoch.Potions);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueuePotionUnlock(Defect4Epoch.Potions);

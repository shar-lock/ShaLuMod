...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Silent7Epoch
...
public class Silent7Epoch : EpochModel
{
  ...
  public static List<CardModel> Cards
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (CardModel) ModelDb.Card<HiddenDaggers>();
      int num2 = num1 + 1;
      span[num2] = (CardModel) ModelDb.Card<BladeOfInk>();
      int num3 = num2 + 1;
      span[num3] = (CardModel) ModelDb.Card<PhantomBlades>();
      return cards;
    }
  }

  public override string UnlockText => this.CreateCardUnlockText(Silent7Epoch.Cards);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueCardUnlock((IReadOnlyList<CardModel>) Silent7Epoch.Cards);
  }
}

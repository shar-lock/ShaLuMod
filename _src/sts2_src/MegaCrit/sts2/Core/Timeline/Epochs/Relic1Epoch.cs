...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Relic1Epoch
...
public class Relic1Epoch : EpochModel
{
  ...
  public static List<RelicModel> Relics
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (RelicModel) ModelDb.Relic<UnsettlingLamp>();
      int num2 = num1 + 1;
      span[num2] = (RelicModel) ModelDb.Relic<IntimidatingHelmet>();
      int num3 = num2 + 1;
      span[num3] = (RelicModel) ModelDb.Relic<ReptileTrinket>();
      return relics;
    }
  }

  public override string UnlockText => this.CreateRelicUnlockText(Relic1Epoch.Relics);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueRelicUnlock(Relic1Epoch.Relics);
  }
}

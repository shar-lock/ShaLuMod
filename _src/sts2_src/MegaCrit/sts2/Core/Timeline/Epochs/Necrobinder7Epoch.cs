...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Necrobinder7Epoch
...
public class Necrobinder7Epoch : EpochModel
{
  ...
  public static List<CardModel> Cards
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (CardModel) ModelDb.Card<SculptingStrike>();
      int num2 = num1 + 1;
      span[num2] = (CardModel) ModelDb.Card<Veilpiercer>();
      int num3 = num2 + 1;
      span[num3] = (CardModel) ModelDb.Card<BansheesCry>();
      return cards;
    }
  }

  public override string UnlockText => this.CreateCardUnlockText(Necrobinder7Epoch.Cards);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueCardUnlock((IReadOnlyList<CardModel>) Necrobinder7Epoch.Cards);
  }
}

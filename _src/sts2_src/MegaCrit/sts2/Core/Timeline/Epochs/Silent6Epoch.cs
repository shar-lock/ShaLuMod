...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Silent6Epoch
...
public class Silent6Epoch : EpochModel
{
  ...
  public static List<RelicModel> Relics
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (RelicModel) ModelDb.Relic<TwistedFunnel>();
      int num2 = num1 + 1;
      span[num2] = (RelicModel) ModelDb.Relic<SneckoSkull>();
      int num3 = num2 + 1;
      span[num3] = (RelicModel) ModelDb.Relic<HelicalDart>();
      return relics;
    }
  }

  public override string UnlockText => this.CreateRelicUnlockText(Silent6Epoch.Relics);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueRelicUnlock(Silent6Epoch.Relics);
  }
}

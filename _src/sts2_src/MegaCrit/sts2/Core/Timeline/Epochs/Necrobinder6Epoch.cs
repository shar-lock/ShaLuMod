...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Necrobinder6Epoch
...
public class Necrobinder6Epoch : EpochModel
{
  ...
  public static List<RelicModel> Relics
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (RelicModel) ModelDb.Relic<IvoryTile>();
      int num2 = num1 + 1;
      span[num2] = (RelicModel) ModelDb.Relic<BigHat>();
      int num3 = num2 + 1;
      span[num3] = (RelicModel) ModelDb.Relic<Bookmark>();
      return relics;
    }
  }

  public override string UnlockText => this.CreateRelicUnlockText(Necrobinder6Epoch.Relics);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueRelicUnlock(Necrobinder6Epoch.Relics);
  }
}

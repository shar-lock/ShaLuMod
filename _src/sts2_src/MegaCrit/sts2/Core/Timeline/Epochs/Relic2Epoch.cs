...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Relic2Epoch
...
public class Relic2Epoch : EpochModel
{
  ...
  public static List<RelicModel> Relics
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (RelicModel) ModelDb.Relic<BookOfFiveRings>();
      int num2 = num1 + 1;
      span[num2] = (RelicModel) ModelDb.Relic<IceCream>();
      int num3 = num2 + 1;
      span[num3] = (RelicModel) ModelDb.Relic<Kusarigama>();
      return relics;
    }
  }

  public override string UnlockText => this.CreateRelicUnlockText(Relic2Epoch.Relics);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueRelicUnlock(Relic2Epoch.Relics);
  }
}

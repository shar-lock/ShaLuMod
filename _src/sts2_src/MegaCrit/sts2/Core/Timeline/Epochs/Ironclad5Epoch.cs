...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Ironclad5Epoch
...
public class Ironclad5Epoch : EpochModel
{
  ...
  public static List<CardModel> Cards
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (CardModel) ModelDb.Card<Cinder>();
      int num2 = num1 + 1;
      span[num2] = (CardModel) ModelDb.Card<PactsEnd>();
      int num3 = num2 + 1;
      span[num3] = (CardModel) ModelDb.Card<DrumOfBattle>();
      return cards;
    }
  }

  public override string UnlockText => this.CreateCardUnlockText(Ironclad5Epoch.Cards);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueCardUnlock((IReadOnlyList<CardModel>) Ironclad5Epoch.Cards);
  }
}

...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Colorless3Epoch
...
public class Colorless3Epoch : EpochModel
{
  ...
  public static List<CardModel> Cards
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (CardModel) ModelDb.Card<Rend>();
      int num2 = num1 + 1;
      span[num2] = (CardModel) ModelDb.Card<BeatDown>();
      int num3 = num2 + 1;
      span[num3] = (CardModel) ModelDb.Card<Prowess>();
      return cards;
    }
  }

  public override string UnlockText => this.CreateCardUnlockText(Colorless3Epoch.Cards);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueCardUnlock((IReadOnlyList<CardModel>) Colorless3Epoch.Cards);
  }
}

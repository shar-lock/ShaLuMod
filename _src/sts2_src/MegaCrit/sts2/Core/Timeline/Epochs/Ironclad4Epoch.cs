...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Ironclad4Epoch
...
public class Ironclad4Epoch : EpochModel
{
  ...
  public static List<PotionModel> Potions
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (PotionModel) ModelDb.Potion<BloodPotion>();
      int num2 = num1 + 1;
      span[num2] = (PotionModel) ModelDb.Potion<SoldiersStew>();
      int num3 = num2 + 1;
      span[num3] = (PotionModel) ModelDb.Potion<Ashwater>();
      return potions;
    }
  }

  public override string UnlockText => this.CreatePotionUnlockText(Ironclad4Epoch.Potions);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueuePotionUnlock(Ironclad4Epoch.Potions);

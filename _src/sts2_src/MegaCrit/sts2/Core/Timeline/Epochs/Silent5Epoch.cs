...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Silent5Epoch
...
public class Silent5Epoch : EpochModel
{
  ...
  public static List<CardModel> Cards
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (CardModel) ModelDb.Card<Reflex>();
      int num2 = num1 + 1;
      span[num2] = (CardModel) ModelDb.Card<MasterPlanner>();
      int num3 = num2 + 1;
      span[num3] = (CardModel) ModelDb.Card<HandTrick>();
      return cards;
    }
  }

  public override string UnlockText => this.CreateCardUnlockText(Silent5Epoch.Cards);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueCardUnlock((IReadOnlyList<CardModel>) Silent5Epoch.Cards);
  }
}

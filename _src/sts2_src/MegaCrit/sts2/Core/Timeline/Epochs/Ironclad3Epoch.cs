...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Ironclad3Epoch
...
public class Ironclad3Epoch : EpochModel
{
  ...
  public static List<RelicModel> Relics
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (RelicModel) ModelDb.Relic<RedSkull>();
      int num2 = num1 + 1;
      span[num2] = (RelicModel) ModelDb.Relic<PaperPhrog>();
      int num3 = num2 + 1;
      span[num3] = (RelicModel) ModelDb.Relic<RuinedHelmet>();
      return relics;
    }
  }

  public override string UnlockText => this.CreateRelicUnlockText(Ironclad3Epoch.Relics);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueRelicUnlock(Ironclad3Epoch.Relics);
  }
}

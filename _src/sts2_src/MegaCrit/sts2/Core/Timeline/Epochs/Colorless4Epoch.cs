...
// Type: MegaCrit.Sts2.Core.Timeline.Epochs.Colorless4Epoch
...
public class Colorless4Epoch : EpochModel
{
  ...
  public static List<CardModel> Cards
  {
    get
    {
      ...
      int num1 = 0;
      span[num1] = (CardModel) ModelDb.Card<Alchemize>();
      int num2 = num1 + 1;
      span[num2] = (CardModel) ModelDb.Card<Nostalgia>();
      int num3 = num2 + 1;
      span[num3] = (CardModel) ModelDb.Card<Scrawl>();
      return cards;
    }
  }

  public override string UnlockText => this.CreateCardUnlockText(Colorless4Epoch.Cards);

  public override void QueueUnlocks()
  {
    NTimelineScreen.Instance.QueueCardUnlock((IReadOnlyList<CardModel>) Colorless4Epoch.Cards);
  }
}

...
// Type: MegaCrit.Sts2.Core.Multiplayer.Messages.Game.CrystalSphereRewardsMessage
  ...
  IRunLocationTargetedMessage
{
  ...
  public void Serialize(PacketWriter writer)
  {
    ...
    writer.WriteList<SerializableCrystalSphereItem>((IReadOnlyList<SerializableCrystalSphereItem>) this.rewards);
  }

  public void Deserialize(PacketReader reader)
  {
    this.Location = reader.Read<RunLocation>();
    this.rewards = reader.ReadList<SerializableCrystalSphereItem>();
  }
}

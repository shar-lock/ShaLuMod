...
// Type: MegaCrit.Sts2.Core.Multiplayer.Messages.Game.Checksums.ChecksumDataMessage
...
public struct ChecksumDataMessage : INetMessage, IPacketSerializable
{
  ...
  public void Serialize(PacketWriter writer) => writer.Write<NetChecksumData>(this.checksumData);

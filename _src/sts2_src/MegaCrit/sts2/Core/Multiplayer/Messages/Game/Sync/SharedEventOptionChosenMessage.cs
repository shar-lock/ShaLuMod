...
// Type: MegaCrit.Sts2.Core.Multiplayer.Messages.Game.Sync.SharedEventOptionChosenMessage
...
public struct SharedEventOptionChosenMessage : 
  INetMessage,
  IPacketSerializable,
  IRunLocationTargetedMessage
{
  ...
  {
    return $"{nameof (SharedEventOptionChosenMessage)} index {this.optionIndex} page {this.pageIndex}";
  }
}

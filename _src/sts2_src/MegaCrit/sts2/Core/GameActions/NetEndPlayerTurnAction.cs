...
// Type: MegaCrit.Sts2.Core.GameActions.NetEndPlayerTurnAction
...
public struct NetEndPlayerTurnAction : INetAction, IPacketSerializable
{
  ...
  {
    return (GameAction) new EndPlayerTurnAction(player, this.turnNumber);
  }
  ...
  public override string ToString() => $"{nameof (NetEndPlayerTurnAction)} turn: {this.turnNumber}";
}

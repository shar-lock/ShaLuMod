...
// Type: MegaCrit.Sts2.Core.Nodes.Screens.Settings.NResetGraphicsButton
...
public class NResetGraphicsButton : NSettingsButton
{
  ...
  private async Task ResetSettingsAfterConfirmation()
  {
    ...
    if (!await modalToCreate.WaitForConfirmation(new LocString("settings_ui", "RESET_GRAPHICS_CONFIRMATION.body"), new LocString("settings_ui", "RESET_CONFIRMATION.header"), new LocString("main_menu_ui", "GENERIC_POPUP.cancel"), new LocString("main_menu_ui", "GENERIC_POPUP.confirm")))
      return;
  ...
  List<MethodInfo> GetGodotMethodList()
  {
    ...
    {
      new MethodInfo(NResetGraphicsButton.MethodName._Ready, new PropertyInfo((Variant.Type) 0L, StringName.op_Implicit(""), (PropertyHint) 0L, "", (PropertyUsageFlags) 6L, false), (MethodFlags) 1L, (List<PropertyInfo>) null, (List<Variant>) null),
      new MethodInfo(NResetGraphicsButton.MethodName.OnRelease, new PropertyInfo((Variant.Type) 0L, StringName.op_Implicit(""), (PropertyHint) 0L, "", (PropertyUsageFlags) 6L, false), (MethodFlags) 1L, (List<PropertyInfo>) null, (List<Variant>) null)
    };
  }
  ...
  {
    if (StringName.op_Equality(ref method, NResetGraphicsButton.MethodName._Ready) && ((NativeVariantPtrArgs) ref args).Count == 0)
    {
      ((Node) this)._Ready();
      ret = new godot_variant();
      return true;
    }
    if (!StringName.op_Equality(ref method, NResetGraphicsButton.MethodName.OnRelease) || ((NativeVariantPtrArgs) ref args).Count != 0)
  ...
  {
    return StringName.op_Equality(ref method, NResetGraphicsButton.MethodName._Ready) || StringName.op_Equality(ref method, NResetGraphicsButton.MethodName.OnRelease) || base.HasGodotClassMethod(in method);
  }
